          ...
          <button onClick={() => setView("storefront")} className="flex items-center gap-3">
            <div className="relative w-8 h-8">
              <svg viewBox="0 0 100 100" className="w-full h-full">
                <defs>
                  <linearGradient id="agentGold" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#f5d27a" /><stop offset="100%" stopColor="#d4af37" />
                  </linearGradient>
                  <linearGradient id="agentBlue" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#4fa9ff" /><stop offset="100%" stopColor="#1e90ff" />
                  </linearGradient>
                </defs>
                <polygon points="50,5 90,27 90,73 50,95 10,73 10,27" fill="none" stroke="url(#agentGold)" strokeWidth="3" />
                <text x="32" y="62" fontFamily="Geist, sans-serif" fontSize="38" fontWeight="900" fill="url(#agentGold)">B</text>
                <text x="55" y="62" fontFamily="Geist, sans-serif" fontSize="38" fontWeight="900" fill="url(#agentBlue)">E</text>
              </svg>
            </div>
